...
Provides the main menu and user interaction flow for starting the game,
viewing statistics, and reading the rules.
"""
...
def main():
    """Main program loop that displays the menu and routes user choices."""
    while True:
        print("\n🎮 MAIN MENU 🎮")
        print("1. Play Game")
